...
<html lang="it">
    ...
    <body>
        ...
        <!--contenuto dinamico della pagina, l'bbiettivo e quello di fare delle 
        ancore che in baso a ciò che viene selezionato il contenuto cambia quindi 
        diverse sezioni : chi siamo , dove siamo , contattaci -->
